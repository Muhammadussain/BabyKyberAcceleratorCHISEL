...
VL_INLINE_OPT void VEncrypt___024root___nba_sequent__TOP__0(VEncrypt___024root* vlSelf) {
    ...
    if (vlSelf->rst_n) {
        if (VL_UNLIKELY(vlSelf->enable)) {
            vlSelf->Encrypt__DOT__unnamedblk2__DOT__i = 4U;
            VL_WRITEF_NX("combined%11d\n",0,32,vlSelf->combined_output
                         [0U][0U][0U]);
            vlSelf->Encrypt__DOT__coefficients = (0xfU 
                                                  & vlSelf->message);
            vlSelf->Encrypt__DOT__stop_random_generation = 1U;
        }
    } else {
        vlSelf->Encrypt__DOT__unnamedblk1__DOT__j = 4U;
        vlSelf->Encrypt__DOT__coefficients = 0U;
    }
...
#endif
            VL_FATAL_MT("/home/hamna/Baby-Kyber-Accelerator/Encrypt.sv", 1, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("/home/hamna/Baby-Kyber-Accelerator/Encrypt.sv", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("/home/hamna/Baby-Kyber-Accelerator/Encrypt.sv", 1, "", "Active region did not converge.");
            }
